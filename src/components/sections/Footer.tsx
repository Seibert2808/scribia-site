    ...
    <footer className="border-t mt-8">
      <div className="container mx-auto py-10 grid gap-6 md:grid-cols-2">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Solução inteligente para transformar conteúdos de eventos em ativos estruturados, ampliando o valor, a continuidade e o potencial de receita para organizadores, palestrantes e patrocinadores.</p>
        </div>
        <div className="md:justify-self-end flex flex-col gap-3">
          ...
          <div className="mt-2 text-sm text-muted-foreground">© {new Date().getFullYear()} {SITE.name}. Todos os direitos reservados.</div>
        </div>
      </div>
    </footer>
  );
